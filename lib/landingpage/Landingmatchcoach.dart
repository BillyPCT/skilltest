...
import 'datamatchcoach/datamathcocach.dart';
import 'detaildarilanding.dart';
class Landingmatchcoach extends StatefulWidget {
  const Landingmatchcoach({super.key});
 //berandasearch(),
  @override
  State<Landingmatchcoach> createState() => _LandingmatchcoachState();
}

class _LandingmatchcoachState extends State<Landingmatchcoach> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        elevation: 0,
        leading: Icon(Iconsax.menu, color: Color.fromARGB(115, 5, 17, 17)),
        actions: [
          Padding(
            padding: EdgeInsets.only(right: 23.0),
            child: Row(
              children: [
                Icon(Iconsax.heart, color: Color.fromARGB(255, 255, 0, 0)),
                const SizedBox(width: 15.0),
                Icon(Iconsax.notification, color: Color.fromARGB(255, 208, 239, 5)),
              ],
            ),
          ),
        ],
